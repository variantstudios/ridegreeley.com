...
<div id="site-wrapper">
  <header>
    ...
    <section id="call-to-action" class="clearfix">
      <article class="actions">
        <a class="blog" href="blog">Ride Greeley Blog</a>
      </article><!--end actions-->
      <article class="actions">
        <a class="services" href="services">Ride Greeley Services</a>
      </article><!--end actions-->
  ...
  <footer class="clearfix">
    ...
    <div id="rights-credits" class="clearfix">
      <p class="rights">All Rights Reserved. Ride Greeley &copy <?php print date('Y'); ?></p>
      <p class="credit"><a href="https://www.variantstudios.com/" target="_blank" rel="author"><span class="tuck">Variant Studios Greeley, Colorado Web Design</span></a></p>

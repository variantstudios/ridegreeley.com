...
<div id="site-wrapper">
  <header>
    <h1><a href="<?php print $front_page ?>" title="<?php print t('Home'); ?>" rel="index"><span class="tuck"><?php print $site_name; ?></span></a></h1>
    ...
    <section id="call-to-action" class="clearfix">
      <article class="actions">
        <a class="blog" href="blog">The Roubaix Bicycle Co. Blog</a>
      </article><!--end actions-->
      <article class="actions">
        <a class="services" href="services">Roubaix Bicycle Co. Services</a>
      </article><!--end actions-->
      <article class="actions last">
        <a class="rides" href="local-ride-maps">Local Rides</a>
      </article><!--end actions-->
  ...
  <footer class="clearfix">
    <?php print $footer; ?>
    <div id="rights-credits" class="clearfix">
      <p class="rights">All Rights Reserved The Roubaix Bicycle Company &copy <?php print date('Y'); ?></p>
      <p class="credit"><a href="http://www.variantstudios.com/" target="_blank" rel="author"><span class="tuck">Variant Studios, Inc. Greeley, CO Web Design</span></a></p>
    </div><!--end rights-credit-->
	</footer>

...
CKEDITOR.editorConfig = function(config) {
 ...
 /* This toolbar is for client use with limited formatting options */
  config.toolbar_Stripped = [
          ['Format', '-', 'Bold', 'Italic', '-', 'NumberedList','BulletedList','Blockquote' , '-', 'Outdent','Indent'],
          ['PasteText','SpecialChar', '-', 'JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock', '-', 'Link','Unlink','Anchor'],
     ];
